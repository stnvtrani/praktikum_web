...
<form enctype="multipart/form-data" action="proses_login.php" method="post" 
      style="background-color: #b3d7f4; padding: 30px; border: 1px solid #f4e6ce;">
    
    <h3 style="color: #0c0c0c; margin-top: 0; margin-bottom: 20px; text-align: center;">Silahkan Login</h3>
